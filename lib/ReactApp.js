		...
		React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					"div",
					null,
					"creates and enters a chat room named Super Secret Chat. Use underscores _ or periods . where you want spaces in your chat's name. Chat room names are not searchable and can be up to 22 characters in length."
				),
				React.createElement(
					"div",
					{ className: "mt-3" },
