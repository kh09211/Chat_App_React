		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"div",
						{ className: "text-right text-light mr-2 mr-md-4" },
						"Active Users: ",
...
var WelcomeModal = function (_React$Component4) {
	...
	function WelcomeModal(props) {
		...
		_this5.isUsernameTaken = _this5.isUsernameTaken.bind(_this5);
		_this5.state = {
			isValid: false,
...
var UserDataComponent = function (_React$Component5) {
	...
	_createClass(UserDataComponent, [{
		...
		value: function getToken() {
			...
			axios.post('/getToken', { 'token': token, 'username': username, 'color': color }).then(function (res) {
