		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"div",
						{ className: "grid-left col-12 col-md-9 col-lg-10" },
						mappedComments,
		...
		React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					"div",
					null,
					"creates and enters a chat room named Super Secret Chat. Use underscores _ or periods . where you want spaces in your chat's name. Chat room names are not searchable."
				),
				React.createElement(
					"div",
					{ className: "mt-3" },
...
var UserDataComponent = function (_React$Component6) {
	...
	_createClass(UserDataComponent, [{
		...
		value: function getComments() {
			...
			axios.get('/getComments/' + this.state.room).then(function (res) {
				...
				if (_this9.state.comments.length > 2) {
					if (_this9.state.comments[0].id != dataComments[0].id) {
		...
		value: function render() {
			...
			if (showModal) {
				modal = React.createElement(WelcomeModal, { enterClick: this.enterClick, username: this.state.username, color: this.state.color, colorClick: this.colorClick, handleUsernameChange: this.usernameChange, activeUsers: this.state.activeUsers });
			}
			if (showActiveUsersDropdown) {
